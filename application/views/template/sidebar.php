	...
	<div class="data-scrollbar" data-scroll="1">
		<nav class="iq-sidebar-menu">
			<ul id="iq-sidebar-toggle" class="side-menu">
				...
				<li class=" sidebar-layout <?= $this->uri->segment(2) == 'laporan' ? 'active' : '' ?>">
				...
				<li class=" sidebar-layout<?= $this->uri->segment(2) == 'konfigurasi' ? 'active' : '' ?> ">
					<a href="<?= base_url('admin/konfigurasi') ?>" class="svg-icon">
						...
						</i><span class="ml-2">Konfigurasi</span>
					</a>
				</li>
				...
				<li class="px-3 pt-3 pb-2">
					<span class="text-uppercase small font-weight-bold">Account</span>
				</li>
				<li class=" sidebar-layout <?= $this->uri->segment(2) == 'account' ? 'active' : '' ?> ">
					<a href="<?= base_url('admin/account') ?>" class="svg-icon">
						<i class="">
							<svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						</i><span class="ml-2">Account</span>
					</a>
				</li>
			</ul>
		</nav>
					...
					<ul class="navbar-nav ml-auto navbar-list align-items-center">
						...
						<li class="nav-item nav-icon dropdown">
							<a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<span class="mb-0 ml-2 user-name"><?= $user->email ?></span>
							</a>
